...
REQUIRED_RUNTIME_FILES = [
    ...
    "model_adapters/azure_capacity_planning.py",
    "model_adapters/azure_deadline_planning.py",
    "model_adapters/azure_endpoint_config.py",
    "model_adapters/azure_failure_classification.py",
    "model_adapters/azure_gpt_image_2.py",
    "model_adapters/azure_rate_limit.py",
    "model_adapters/azure_reservation.py",
    "model_adapters/azure_router.py",
...
AVATAR_CONTEXT_REQUIRED = [
    ...
    "lib/ai_recommend_model/avatar_generation/model_adapters/azure_capacity_planning.py",
    "lib/ai_recommend_model/avatar_generation/model_adapters/azure_deadline_planning.py",
    "lib/ai_recommend_model/avatar_generation/model_adapters/azure_endpoint_config.py",
    "lib/ai_recommend_model/avatar_generation/model_adapters/azure_failure_classification.py",
    "lib/ai_recommend_model/avatar_generation/model_adapters/azure_reservation.py",
    "lib/ai_recommend_model/avatar_generation/model_adapters/azure_router.py",
    ...
    "lib/ai_recommend_model/avatar_generation/candidate_artifacts.py",
